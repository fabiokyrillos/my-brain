...
const ptBR: HistoryCopy = {
  ...
  entityTypes: {
    ...
    memory: "memória",
    reminder: "lembrete",
    reminder_series: "repetição de lembrete",
  ...
  actions: {
    ...
    entry_lifecycle_rederived: "atualizou a situação do registro[ “{subject}”]",
    interpretation_confirmed: "confirmou a interpretação do registro[ “{subject}”]",
    notification_suppressed: "silenciou os avisos[ sobre “{subject}”]",
    ...
    reminder_occurrence_materialised: "preparou a próxima ocorrência[ de “{subject}”]",
    ...
    reminder_series_command_undone: "desfez uma alteração na repetição[ “{subject}”]",
    reminder_series_created: "criou a repetição[ “{subject}”]",
    reminder_series_creation_undone: "desfez a criação da repetição[ “{subject}”]",
...
const en: HistoryCopy = {
  ...
  entityTypes: {
    ...
    memory: "memory",
    reminder: "reminder",
    reminder_series: "repeating reminder",
  ...
  actions: {
    ...
    entry_lifecycle_rederived: "updated the record[ “{subject}”] status",
    interpretation_confirmed: "confirmed the interpretation of the record[ “{subject}”]",
    notification_suppressed: "silenced the notices[ about “{subject}”]",
    ...
    reminder_occurrence_materialised: "prepared the next occurrence[ of “{subject}”]",
    ...
    reminder_series_command_undone: "undid a change to the repetition[ “{subject}”]",
    reminder_series_created: "created the repetition[ “{subject}”]",
    reminder_series_creation_undone: "undid creating the repetition[ “{subject}”]",
