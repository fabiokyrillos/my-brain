...
export const dailyCycleCopy = {
  "pt-BR": {
    ...
    attentionReasons: {
      ...
      confirm_existing_candidates: { title: "Confirme as tarefas", description: "Há tarefas sugeridas prontas para sua confirmação." },
    ...
    actions: {
      ...
      confirm_existing_candidates: "Confirmar tarefas",
    ...
    messages: {
      ...
      reprocessing_queued: "Vou organizar este registro novamente.",
      candidates_confirmed: "Tarefas confirmadas.",
      task_creation_undone: "Criação de tarefas desfeita.",
  ...
  en: {
    ...
    attentionReasons: {
      ...
      confirm_existing_candidates: { title: "Confirm the tasks", description: "There are suggested tasks ready for your confirmation." },
    ...
    actions: {
      ...
      confirm_existing_candidates: "Confirm tasks",
    ...
    messages: {
      ...
      reprocessing_queued: "I will organize this record again.",
      candidates_confirmed: "Tasks confirmed.",
      task_creation_undone: "Task creation undone.",
