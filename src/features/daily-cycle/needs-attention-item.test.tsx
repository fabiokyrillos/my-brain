...
describe("NeedsAttentionItemRow", () => {
  it("renders the human title and explanation", () => {
    render(<NeedsAttentionItemRow item={item()} locale="pt-BR" />);
  ...
  it("renders a localized action hint for the primary action id", () => {
    render(<NeedsAttentionItemRow item={item({ primaryAction: { id: "retry_processing", href: "/en/app/inbox/72f1f8af-8b90-4f1d-9916-ec6d983fd4c6" } })} locale="en" />);
  ...
  it("never renders the internal reason string as UI text", () => {
    render(<NeedsAttentionItemRow item={item({ kind: "resolve_consistency", primaryAction: { id: "resolve_consistency", href: "/en/app/inbox/72f1f8af-8b90-4f1d-9916-ec6d983fd4c6" } })} locale="en" />);
