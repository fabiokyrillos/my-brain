...
- `docs/reports/phase-2x/PHASE_2X_PROJECTIONS_PREWORK_REPORT.md` — relatório histórico de Product Projections renomeado/reclassificado como prework.
- `docs/reports/phase-2x/PHASE_2X_SLICE_03_REPORT.md` — este relatório do slice oficial.
