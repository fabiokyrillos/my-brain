...
| `docs/reports/PHASE_2F_SLICE_04_PLAN.md` | the pre-code planning report and inventory |
| `docs/reports/PHASE_2F_SLICE_04_BLAST_RADIUS.md` | the pre-implementation blast-radius summary |
...
| R8 | **`docs/reports/SLICE_REPORT_TEMPLATE.md` remains dead** and the remaining `TODO.md:228` documentation items remain open. | Out of frozen scope; left for 2F.6's 2F-OPERATIONS-006. |
