...
| `docs/STATE.md`, `docs/CHANGELOG.md`, `docs/TODO.md`, `docs/reports/phase-2f/PHASE_2F_SLICE_02_REPORT.md` | Definition of Done. `DECISIONS.md` only if an architectural decision arises; none is anticipated (the PRD already carries ADR-054…057). |
