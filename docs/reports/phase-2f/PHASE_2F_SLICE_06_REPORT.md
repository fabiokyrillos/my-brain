...
**Convergence and closeout.** Governed by `docs/reports/phase-2f/PHASE_2F_SLICE_06_PRD.md` (Revision 2, definitive). Scope: `2F-OPERATIONS-003`, `004`, `005`, `006`, the whole-phase convergence audit, and the phase's closeout record. Nothing else.
...
| `docs/reports/phase-2f/PHASE_2F_REPORT.md` | new — the final phase report |
| `docs/reports/phase-2f/PHASE_2F_TRACEABILITY_MATRIX.md` | new — generated |
