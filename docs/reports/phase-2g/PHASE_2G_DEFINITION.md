...
> record: `docs/reports/entity-graph/ENTITY_GRAPH_FINDINGS.md`. The closed UX ledger is untouched.
...
[`ENTITY_GRAPH_FINDINGS.md`](../entity-graph/ENTITY_GRAPH_FINDINGS.md), which files nine observations
...
[`BYOK_SECURITY_DEFINITION.md`](../byok/BYOK_SECURITY_DEFINITION.md), not here.
