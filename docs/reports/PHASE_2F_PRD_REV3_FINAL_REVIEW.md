...
Reviewed 2026-07-29 against the normative hierarchy: repository truth at `b54b833` (remote parity `202607280061`) → `docs/reports/PHASE_2F_PRE_CODE_GATE_REPORT.md` → the four fixed owner decisions → `docs/PHASE_2F_PRD.md` Revision 3.
