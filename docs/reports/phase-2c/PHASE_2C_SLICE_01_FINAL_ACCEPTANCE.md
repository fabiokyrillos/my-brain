...
- `docs/reports/phase-2c/PHASE_2C_SLICE_01_RED.md`, `_DATABASE_GREEN.md`, `_TS_CONTRACT_GREEN.md`, `_DUE_DATE_GREEN.md`, `_CANDIDATE_EDITOR_GREEN.md`, `_INTEGRATION_GREEN.md`.
...
See `docs/reports/phase-2c/PHASE_2C_SLICE_01_FINAL_ACCEPTANCE.md` for the full
