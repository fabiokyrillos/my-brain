 ...
 * `docs/initiatives/entity-graph/ENTITY_GRAPH_COMPLETION_PRD.md`, from the implementation plan's own
...
export function declaredRequirements(root) {
  const prd = readFileSync(join(root, "docs/initiatives/entity-graph/ENTITY_GRAPH_COMPLETION_PRD.md"), "utf8");
...
export function sliceOwnership(root) {
  const plan = readFileSync(join(root, "docs/initiatives/entity-graph/ENTITY_GRAPH_COMPLETION_IMPLEMENTATION_PLAN.md"), "utf8");
