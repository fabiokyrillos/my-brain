-- Forward fix for Phase 2C Slice 2C.4 candidate disposition undo.
--
-- Migration 041 is already applied. Replace only the exact current
-- undo_operation(uuid) implementation and avoid an unresolved function lookup under
-- its explicit empty search_path.
